...
pub fn derive_command_from_key_assignment(action: &KeyAssignment) -> Option<CommandDef> {
    Some(match action {
        ...
        AutoTileResizePane(PaneDirection::Left, amount) => CommandDef {
            brief: format!("Auto-Tile Resize {amount} cell(s) Left & Lock").into(),
            doc: "Resize pane to the left and lock it from auto-tiling".into(),
            keys: vec![(Modifiers::SUPER.union(Modifiers::SHIFT), "LeftArrow".into())],
            args: &[ArgType::ActivePane],
            menubar: &["Window", "Auto-Tile Resize"],
            icon: None,
        },
        AutoTileResizePane(PaneDirection::Right, amount) => CommandDef {
            brief: format!("Auto-Tile Resize {amount} cell(s) Right & Lock").into(),
            doc: "Resize pane to the right and lock it from auto-tiling".into(),
            keys: vec![(Modifiers::SUPER.union(Modifiers::SHIFT), "RightArrow".into())],
            args: &[ArgType::ActivePane],
            menubar: &["Window", "Auto-Tile Resize"],
            icon: None,
        },
        AutoTileResizePane(PaneDirection::Up, amount) => CommandDef {
            brief: format!("Auto-Tile Resize {amount} cell(s) Up & Lock").into(),
            doc: "Resize pane upwards and lock it from auto-tiling".into(),
            keys: vec![(Modifiers::SUPER.union(Modifiers::SHIFT), "UpArrow".into())],
            args: &[ArgType::ActivePane],
            menubar: &["Window", "Auto-Tile Resize"],
            icon: None,
        },
        AutoTileResizePane(PaneDirection::Down, amount) => CommandDef {
            brief: format!("Auto-Tile Resize {amount} cell(s) Down & Lock").into(),
            doc: "Resize pane downwards and lock it from auto-tiling".into(),
...
fn compute_default_actions() -> Vec<KeyAssignment> {
    ...
    return vec![
        ...
        AutoTileResizePane(PaneDirection::Left, 1),
